...
<execution_context>
@C:/cash/.claude/get-shit-done/workflows/list-workspaces.md
@C:/cash/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @C:/cash/.claude/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
